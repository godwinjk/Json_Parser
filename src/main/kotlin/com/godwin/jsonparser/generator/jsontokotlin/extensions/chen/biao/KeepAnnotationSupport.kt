 ...
 * description:
 */
object KeepAnnotationSupport : com.godwin.jsonparser.generator.jsontokotlin.extensions.Extension() {
    ...
    override fun createUI(): JPanel {
        return jHorizontalLinearLayout {
            jCheckBox("Add @Keep Annotation On Class ", getConfig(configKey).toBoolean(), { isSelected ->
                setConfig(
