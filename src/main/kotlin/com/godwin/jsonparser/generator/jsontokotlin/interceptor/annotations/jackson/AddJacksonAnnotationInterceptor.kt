...
import com.godwin.jsonparser.generator.jsontokotlin.model.codeannotations.JacksonPropertyAnnotationTemplate
    ...
    override fun intercept(kotlinClass: KotlinClass): KotlinClass {
        ...
        if (kotlinClass is DataClass) {
            val addMoshiCodeGenAnnotationProperties = kotlinClass.properties.map {
                ...
                it.copy(
                    annotations = JacksonPropertyAnnotationTemplate(it.originName).getAnnotations(),
                    name = camelCaseName
                )
            }
