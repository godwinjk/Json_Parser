...
import com.godwin.jsonparser.generator.jsontokotlin.model.classscodestruct.ListClass
    ...
    fun generate(): ListClass {
        ...
        when {
            ...
            jsonArray.allItemAreNullElement() -> {
                Log.i("$tag jsonArray allItemAreNullElement, return ListClass with generic type ${KotlinClass.ANY.name}")
                return ListClass(name = className, generic = KotlinClass.ANY, nullableElements = true)
            }
            ...
            jsonArrayExcludeNull.allElementAreSamePrimitiveType() -> {
                ...
                Log.i("$tag jsonArray allElementAreSamePrimitiveType, return ListClass with generic type ${elementKotlinClass.name}")
