...
import com.godwin.jsonparser.generator_kt.jsontokotlin.model.builder.KotlinEnumCodeBuilder
...
data class EnumClass(
    ...
    override fun replaceReferencedClasses(replaceRule: Map<KotlinClass, KotlinClass>): EnumClass {
        return if (replaceRule.isEmpty()) this else copy(
            generic = replaceRule.values.toList()[0],
            referencedClasses = replaceRule.values.toList()
        )
    }
}