...
public class JsonCodeStyleUtilsTest {

    @Test
    public void testValidJson_remainsUnchanged() {
        String json = "{\"first_Name\": \"John\", \"last_Name\": \"Doe\",\"Age\": 20}";
        assertEquals(json, JsonUtils.INSTANCE.cleanUpJsonString(json));
    }
    ...
    public void testMissingBothBraces() {
        ...
        assertEquals(expected, JsonUtils.INSTANCE.cleanUpJsonString(json));
    }
